...
def resnet18_sub(pretrained=True, progress=True, name=None, created_time=None,  **kwargs):
...
if __name__ == '__main__':
    ...
    data_dir = '../data/sub-imagenet-200/'
    ...
    target_model = resnet18_sub(name='Target',
                                created_time='')
